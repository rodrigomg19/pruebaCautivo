"use strict"; function _typeof(t) { 
        ...
        s = p.enableUtc ? new Date(
            ...
            r, Array.prototype.forEach.call(y, function (t) { 
                var n, r = t, y = function (t, n) { 
                    var o; return t.inline ? ((o = document.createElement("span")).classList.add(t.inlineClass), o) : { 
                ...
                (n = function () { 
                    ...
                    f = function () { 
                        ...
                        c > 0 ? f() : p.countUp ? (c = (a.getTime() - s) / 1e3, f()) : (
                            i = 0, 
                            l = 0, 
                            u = 0, 
                            m = 0, 
                            window.clearInterval(o), p.onEnd()
                        ), 
                        p.plural ? (
                            t = i > 1 ? p.words.days + 
                            p.words.pluralLetter : p.words.days, e = l > 1 ? p.words.hours + 
                            p.words.pluralLetter : p.words.hours, n = u > 1 ? p.words.minutes + 
                            p.words.pluralLetter : p.words.minutes, w = m > 1 ? p.words.seconds + 
                            p.words.pluralLetter : p.words.seconds
                        ) : (
                            t = p.words.days, 
                            e = p.words.hours, 
                            n = p.words.minutes, 
                        ...
                        p.inline ? r.innerHTML = "".concat(i, " ").concat(t, ", ") + 
                        "".concat(l, " ").concat(e, ", ") + 
                        "".concat(u, " ").concat(n, ", ") + 
                        "".concat(m, " ").concat(w, ".") : 
                        (
    ...
    }}(window), window.jQuery && function (t, e) { t.fn.simplyCountdown = function (t) { 
        return function (t, n) { e(t, n) }(this.selector, t) 
